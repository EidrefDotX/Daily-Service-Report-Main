...
def create_app() -> Flask:
    ...
    class Report(Base):  # type: ignore[name-defined]
        ...
        engineer_signature: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
        customer_signature: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    ...
    def submit_report():  # type: ignore[no-untyped-def]
        ...
        new_report = Report(
            ...
            engineer_signature=payload.get("engineerSignature", ""),
            customer_signature=payload.get("customerSignature", ""),
        )
